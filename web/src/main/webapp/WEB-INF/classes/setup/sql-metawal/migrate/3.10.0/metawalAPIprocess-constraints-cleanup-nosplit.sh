...
curl -X POST "$CATALOG/srv/api/0.1/processes/mw-constraints-cleanup-nosplit?bucket=111&updateDateStamp=false&index=true" -H "accept: application/json" -H "X-XSRF-TOKEN: $TOKEN" -c /tmp/cookie -b /tmp/cookie --user $CATALOGUSER:$CATALOGPASS
