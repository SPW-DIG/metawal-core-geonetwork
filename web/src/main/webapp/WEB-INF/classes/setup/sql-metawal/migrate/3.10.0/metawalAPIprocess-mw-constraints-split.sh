...
curl -X POST "$CATALOG/srv/api/0.1/processes/mw-constraints-split?bucket=111&updateDateStamp=false&index=true" -H "accept: application/json" -H "X-XSRF-TOKEN: $TOKEN" -c /tmp/cookie -b /tmp/cookie --user $CATALOGUSER:$CATALOGPASS
