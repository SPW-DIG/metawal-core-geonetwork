...
//    'series': 'Ensemble de séries de données',
    ...
    'dataset': 'Géodonnées',
    'series': 'Séries',
    'application': 'Applications cartographiques',
    ...
    'advancedSearchOptions': 'Critères avancés de recherche',
    'getMEF': 'Export (ZIP)',
    ...
    'relatedservices': 'Métadonnées des services et applications associées',
    ...
    'linklabel-application/vnd.ogc.wms_xml': 'Visualiser (WMS)',
    ...
    'linklabel-OGC:WMS': 'Visualiser (WMS)',
    'linklabel-ESRI:REST': 'Visualiser (REST)',
