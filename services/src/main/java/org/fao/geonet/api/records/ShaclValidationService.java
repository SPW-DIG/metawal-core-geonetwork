...
public class ShaclValidationService {
    ...
    public String validate(String formatter, AbstractMetadata metadata, List<String> shaclShapes, ServiceContext context, String outputFormat) {
        ...
        if (!report.conforms()) {
            long violationCount = report.getEntries().stream()
