...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};(function(){angular.module("gn_editor_controller",[]).controller("GnEditorController",["$scope","$routeParams","$http","$rootScope","$translate","$compile","gnMetadataManagerService","gnSearchManagerService","gnUtilityService",function(a,b,c,d,e,g,f,l,k){a.metadataUuid="da165110-88fd-11da-a88f-000d939bc5d8";a.metadataId="1246";a.getEditorForm=function(){return"md.edit?id="+a.metadataId};a.remove=function(b,d){c.get("md.element.remove@json?id="+a.metadataId+"&ref="+b+"&parent="+d).success(function(a){$("#gn-el-"+
b).slideUp(300,function(){$(this).remove()})}).error(function(a){console.log(a)})};a.add=function(b,d,e){c.get("md.element.add?id="+a.metadataId+"&ref="+b+"&name="+d).success(function(a){console.log(a);$("#gn-el-"+e).after(a)}).error(function(a){console.log(a)})};a.save=function(){c.post("md.edit.save",$("#gn-editor-"+a.metadataId).serialize(),{headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(a){console.log(a)}).error(function(a){console.log(a)})};a.reset=function(){}}])})();(function(){var a=angular.module("gn_utility_service",[]);a.factory("gnUtilityService",function(){var a=function(c){angular.forEach(c,function(d,e){if("string"==typeof d)if("true"==d||"false"==d)c[e]="true"==d;else{if("on"==d||"off"==d)c[e]="on"==d}else a(d)})};return{scrollTo:function(a,b,e,g){$(document.body).animate({scrollTop:b?$(a).offset().top:$(a).position().top},e,g)},serialize:function(a){a=$(a);var b=[];$(":checkbox:not(:checked)",a).each(function(){b.push(encodeURIComponent(this.name)+
"=false")});return a.serialize().replace(/=on/g,"=true")+(b.length?"&"+b.join("&").replace(/%20/g,"+"):"")},parseBoolean:a,toCsv:function(a,b,e){var g,f,l=[],k,m,r,h,n="",p,t;if("undefined"===typeof b||null===b)b='"';if("undefined"===typeof e||null===e)e=",";g=0;for(f=a.length;g<f;g+=1){r=a[g];h="";if(0===g){for(k in r)r.hasOwnProperty(k)&&(l.push(k),h+=[b,k,b,e].join(""));h=h.substring(0,h.length-1);n+=h}n+="\n";h="";p=0;for(t=l.length;p<t;p+=1){k=l[p];m=r[k];0<p&&(h+=",");var q='"',s=typeof m,u=
void 0;if("undefined"===typeof q||null===q)q='"';u="undefined"===s||null===s?"":"string"===s?q+m+q:String(m);h+=u}n+=h}return n}}});a.filter("gnFromNow",function(){return function(a){return moment(new Date(a)).fromNow()}})})();(function(){var a=angular.module("gn_search_manager_service",[]),b=function(a,b,e){var g=function(a){var b={},d=-1;a[0]&&a[0]["@count"]&&(a.summary=a[0],d=a[0]["@count"]);for(var c in a.summary)"@count"!=c?(b[c]=a.summary[c],b[c].name=c):d=a.summary[c];if(a.metadata)for(c=0;c<a.metadata.length||!$.isArray(a.metadata)&&1>c;c++){var e=$.isArray(a.metadata)?a.metadata[c]:a.metadata;"string"===typeof e.image&&(e.image=[e.image]);"string"===typeof e.link&&(e.link=[e.link]);e["geonet:info"].selected="true"==
