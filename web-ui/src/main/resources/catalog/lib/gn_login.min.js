...
"=false")});return a.serialize().replace(/=on/g,"=true")+(b.length?"&"+b.join("&").replace(/%20/g,"+"):"")},parseBoolean:a,toCsv:function(a,b,e){var g,f,m=[],k,l,r,h,n="",p,t;if("undefined"===typeof b||null===b)b='"';if("undefined"===typeof e||null===e)e=",";g=0;for(f=a.length;g<f;g+=1){r=a[g];h="";if(0===g){for(k in r)r.hasOwnProperty(k)&&(m.push(k),h+=[b,k,b,e].join(""));h=h.substring(0,h.length-1);n+=h}n+="\n";h="";p=0;for(t=m.length;p<t;p+=1){k=m[p];l=r[k];0<p&&(h+=",");var q='"',s=typeof l,u=
