...
"=false")});return a.serialize().replace(/=on/g,"=true")+(b.length?"&"+b.join("&").replace(/%20/g,"+"):"")},parseBoolean:a,toCsv:function(a,b,e){var g,f,h=[],k,l,n,m,p="",q,r;if("undefined"===typeof b||null===b)b='"';if("undefined"===typeof e||null===e)e=",";g=0;for(f=a.length;g<f;g+=1){n=a[g];m="";if(0===g){for(k in n)n.hasOwnProperty(k)&&(h.push(k),m+=[b,k,b,e].join(""));m=m.substring(0,m.length-1);p+=m}p+="\n";m="";q=0;for(r=h.length;q<r;q+=1){k=h[q];l=n[k];0<q&&(m+=",");var s='"',t=typeof l,u=
...
function(b){c.get("admin.usergroups.list@json?id="+b.id).success(function(c){a.userGroups=c;a.userSelected=b;a.userIsAdmin="Administrator"===b.profile}).error(function(a){});a.userRecordsFilter={template:"y or n",_owner:b.id,sortBy:"title"};a.userRecordsSearch();a.userUpdated=!1};a.resetPassword1=null;a.resetPassword2=null;a.resetPassword=function(){a.resetPassword1=null;a.resetPassword2=null;$("#passwordResetModal").modal()};a.saveNewPassword=function(){c.post("user.update@json",null,{params:{operation:"resetpw",
id:a.userSelected.id,password:a.resetPassword1,password2:a.resetPassword2}}).success(function(b){a.resetPassword1=null;a.resetPassword2=null;$("#passwordResetModal").modal("hide")}).error(function(a){})};a.isUserGroup=function(b,c){if(a.userGroups)for(var d=0;d<a.userGroups.length;d++)if(a.userGroups[d].id==b&&a.userGroups[d].profile==c)return!0;return!1};a.setUserProfile=function(b){a.userUpdated=!0;if(b){for(b=0;b<a.profiles.length;b++)"Administrator"!==a.profiles[b]&&($("#groups_"+a.profiles[b])[0].selectedIndex=
-1);a.userSelected.profile=a.userIsAdmin?"Administrator":a.profiles[0]}else{var c="RegisteredUser";for(b=0;b<a.profiles.length;b++)if("Administrator"!==a.profiles[b]){var d=$("#groups_"+a.profiles[b])[0];-1<d.selectedIndex&&""!=d.options[d.selectedIndex].value&&(c=a.profiles[b])}a.userSelected.profile=c;b=$("#groups_Editor")[0];c=$("#groups_Reviewer")[0];if(-1<c.selectedIndex)for(d=0;d<c.options.length;d++)c.options[d].selected&&(b.options[d].selected=!0)}};a.updatingUser=function(){a.userUpdated=
!0};a.saveUser=function(b){"Administrator"===a.user.profile||"UserAdmin"===a.user.profile?c.get("admin.user.update?"+$(b).serialize()).success(function(b){a.unselectUser();l();d.$broadcast("StatusUpdated",{msg:e("userUpdated"),timeout:2,type:"success"})}).error(function(a){d.$broadcast("StatusUpdated",{title:e("userUpdateError"),error:a,timeout:0,type:"danger"})}):c.get("user.infoupdate?"+$(b).serialize()).success(function(b){a.unselectUser();l();d.$broadcast("StatusUpdated",{msg:e("userUpdated"),
timeout:2,type:"success"})}).error(function(a){d.$broadcast("StatusUpdated",{title:e("userUpdateError"),error:a,timeout:0,type:"danger"})})};a.deleteUser=function(b){c.get("admin.user.remove?id="+a.userSelected.id).success(function(b){a.unselectUser();l()}).error(function(a){d.$broadcast("StatusUpdated",{title:e("userDeleteError"),error:a,timeout:0,type:"danger"})})};a.userHasRecords=function(){return a.userRecords&&a.userRecords.metadata&&0<a.userRecords.metadata.length};a.addGroup=function(){a.unselectGroup();
a.groupSelected={id:"",name:"",description:"",email:""}};a.saveGroup=function(b){c.get("admin.group.update?"+$(b).serialize()).success(function(b){a.unselectGroup();k();d.$broadcast("StatusUpdated",{msg:e("groupUpdated"),timeout:2,type:"success"})}).error(function(a){d.$broadcast("StatusUpdated",{title:e("groupUpdateError"),error:a,timeout:0,type:"danger"})})};a.deleteGroup=function(b){c.get("admin.group.remove?id="+a.groupSelected.id).success(function(b){a.unselectGroup();k()}).error(function(a){d.$broadcast("StatusUpdated",
{title:e("groupDeleteError"),error:a,timeout:0,type:"danger"})})};a.groupHasRecords=function(){return a.groupRecords&&a.groupRecords.metadata&&0<a.groupRecords.metadata.length};a.unselectGroup=function(){a.groupSelected=null;a.groupUpdated=!1;a.groupRecords=null};a.selectGroup=function(b){a.groupSelected=b;a.groupRecordsFilter={template:"y or n",group:b.id,sortBy:"title"};a.groupRecordsSearch();a.groupUpdated=!1};a.updatingGroup=function(){a.groupUpdated=!0};k();l()}])})();(function(){angular.module("gn_standards_controller",[]).controller("GnStandardsController",["$scope","$routeParams","$http","$rootScope","$translate","$compile","gnMetadataManagerService","gnSearchManagerService","gnUtilityService",function(a,b,c,d,e,g,f,h,k){function l(){c.get("admin.schema.list@json").success(function(b){for(var c=0;c<b.length;c++)a.schemas.push({id:b[c]["#text"].trim(),props:b[c]});a.schemas.sort()})}a.pageMenu={folder:"standards/",defaultTab:"standards",tabs:[]};a.schemas=[];
...
d){a.isIndexing="true"==c.index;a.isIndexing&&f(m,q);b.get("qi@json?template=y or n or s&summaryOnly=true").success(function(b,c){a.numberOfIndexedRecords=b[0]["@count"]})})}a.pageMenu={folder:"tools/",defaultTab:"index",tabs:[{type:"index",label:"indexAdmin",icon:"icon-search",href:"#/tools/index"},{type:"batch",label:"batchProcess",icon:"icon-medkit",href:"#/tools/batch"},{type:"transferownership",label:"transfertPrivs",href:"#/tools/transferownership"}]};a.processing=!1;a.recordsToProcessFilter=
"";a.processReport=null;a.processReportWarning=!1;a.recordsToProcess=null;a.numberOfRecordsProcessed=null;a.recordsToProcessPagination={pages:-1,currentPage:0,hitsPerPage:10};a.selectedProcess=null;a.batchProcesses=null;a.batchSearchTemplateY=!0;a.batchSearchTemplateN=!0;a.batchSearchTemplateS=!1;a.batchSearchGroups={};a.batchSearchUsers={};a.batchSearchCategories={};a.editors={};a.groupinfo={};a.editorSelectedId=null;a.editorGroups={};a.selectUser=function(c){a.editorSelectedId=c;b.get("admin.usergroups.list@json?id="+
c).success(function(b){var c={};angular.forEach(b,function(a){c[a.id]||(c[a.id]=a)});a.editorGroups=c}).error(function(a){});b.get("admin.ownership.groups@json?id="+c).success(function(b){b.group||b.targetGroup||(b.group=b,b.targetGroup=b);a.groupinfo={group:[].concat(b.group),targetGroup:[].concat(b.targetGroup)}})};a.transfertList={};a.tranferOwnership=function(f){var e=a.transfertList[f];f="<request><sourceUser>"+a.editorSelectedId+"</sourceUser><sourceGroup>"+f+"</sourceGroup><targetUser>"+e.targetEditor+
"</targetUser><targetGroup>"+e.targetGroup.id+"</targetGroup></request>";e.running=!0;b.post("admin.ownership.transfer@json",f,{headers:{"Content-type":"application/xml"}}).success(function(a){c.$broadcast("StatusUpdated",{msg:d("transfertPrivilegesFinished",{privileges:a.privileges,metadata:a.metadata}),timeout:2,type:"success"});e.running=!1}).error(function(a){e.running=!1})};a.isRunning=function(b){return a.transfertList[b].running};var p=1E3;a.runProcess=function(e){a.processing=!0;a.processReport=
null;b.get("md.processing.batch@json?"+$(e).serialize()).success(function(b){a.processReport=b;a.processReportWarning=0!=b.notFound||0!=b.notOwner||0!=b.notProcessFound;c.$broadcast("StatusUpdated",{msg:d("processFinished"),timeout:2,type:"success"});a.processing=!1;n()}).error(function(b){c.$broadcast("StatusUpdated",{title:d("processError"),error:b,timeout:0,type:"danger"});a.processing=!1});l.scrollTo("#gn-batch-process-report");f(n,p)};(function(){b.get(a.base+"config/batch-process-cfg.json").success(function(b){a.batchProcesses=
b.config})})();n();(function(){b.get("admin.group.list@json").success(function(b){a.batchSearchGroups=b}).error(function(a){})})();(function(){b.get("admin.user.list@json").success(function(b){a.batchSearchUsers=b}).error(function(a){})})();(function(){b.get("info@json?type=categories").success(function(b){a.batchSearchCategories=b.categories}).error(function(a){})})();(function(){b.get("admin.ownership.editors@json").success(function(b){a.editors=b})})();a.recordsToProcessSearchFor=function(b){a.recordsToProcessFilter=
b?b.target.value:"";a.recordsToProcessPagination.currentPage=0;a.recordsToProcessSearch()};a.recordsToProcessSearch=function(){var b=a.recordsToProcessPagination,b=[{fast:"index"},{from:b.currentPage*b.hitsPerPage+1},{to:(b.currentPage+1)*b.hitsPerPage},{any:a.recordsToProcessFilter}];templateValues=[];angular.forEach({"#gn-batchSearchTemplateY":"y","#gn-batchSearchTemplateN":"n","#gn-batchSearchTemplateS":"s"},function(a,b){$(b)[0]&&$(b)[0].checked&&templateValues.push(a)});b.push({template:templateValues.join(" or ")});
if($("#gn-batchSearchGroupOwner")[0]){var c=$("#gn-batchSearchGroupOwner")[0].options[$("#gn-batchSearchGroupOwner")[0].selectedIndex].value;""!==c&&b.push({group:c})}$("#gn-batchSearchOwner")[0]&&(c=$("#gn-batchSearchOwner")[0].options[$("#gn-batchSearchOwner")[0].selectedIndex].value,""!==c&&b.push({_owner:c}));$("#gn-batchSearchCategory")[0]&&(c=$("#gn-batchSearchCategory")[0].options[$("#gn-batchSearchCategory")[0].selectedIndex].value,""!==c&&b.push({category:c}));var d="";angular.forEach(b,
function(a){angular.forEach(a,function(a,b){d+=b+"="+a+"&"})});k.search("q@json?"+d).then(function(b){a.recordsToProcess=b;a.recordsToProcessPagination.pages=Math.round(b.count/a.recordsToProcessPagination.hitsPerPage,0)},function(a){})};angular.forEach(["recordsToProcessPagination.currentPage"],function(b){a.$watch(b,function(){a.recordsToProcessSearch()})});h.selectNone().then(function(){a.recordsToProcessSearch()});a.isIndexing=!1;a.numberOfIndexedRecords=null;var q=1E3;m();a.rebuildIndex=function(){b.get("admin.index.rebuild?reset=yes").success(function(a){m()}).error(function(a){c.$broadcast("StatusUpdated",
{title:d("rebuildIndexError"),error:a,timeout:0,type:"danger"})})};a.optimizeIndex=function(){b.get("admin.index.optimize").success(function(a){c.$broadcast("StatusUpdated",{msg:d("indexOptimizationInProgress"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",{title:d("rebuildIndexError"),error:a,timeout:0,type:"danger"})})};a.reloadLuceneConfig=function(){b.get("admin.index.config.reload").success(function(a){c.$broadcast("StatusUpdated",{msg:d("luceneConfigReloaded"),
...
parseInt(b[e].nbsearch),c+=b[e].nbsearch;a.statistics.search.byServiceType=b;nv.addGraph(function(){var a=nv.models.pieChart().x(function(a){return d(a.service)}).y(function(a){return a.nbsearch}).values(function(a){return a}).tooltips(!0).tooltipContent(function(a,b,e,f){return"<h3>"+a+"</h3><p>"+parseInt(b).toFixed()+" "+d("searches")+" ("+(100*(b/c)).toFixed()+"%)</p>"}).showLabels(!0);d3.select("#gn-stat-search-by-service").datum([b]).transition().duration(1200).call(a);return a})}).error(function(a){})})();
...
-1===d.indexOf("GetCapabilities")&&(d+=(-1===d.indexOf("?")?"?":"&")+"SERVICE=CSW&REQUEST=GetCapabilities&VERSION=2.0.2");b.get(a.proxyUrl+encodeURIComponent(d)).success(function(b){a.cswCriteria=[];try{var d=$.parseXML(b);a.harvesterSelected.searches||(a.harvesterSelected.searches=[{}]);var e=$(d),f=["SupportedISOQueryables","SupportedQueryables","AdditionalQueryables"],g=window.navigator.userAgent.indexOf("MSIE");-1!=navigator.userAgent.indexOf("Firefox")||0<g||navigator.userAgent.match(/Trident\/7\./)?
e.find("ows\\:Constraint").each(function(){-1!==f.indexOf($(this).attr("name"))&&$(this).find("ows\\:Value").each(function(){var b=$(this).text().replace(":","__");a.cswCriteria.push(b);a.harvesterSelected.searches[0][b]||(a.harvesterSelected.searches[0][b]={value:""})})}):e.find("Constraint").each(function(){-1!==f.indexOf($(this).attr("name"))&&$(this).find("Value").each(function(){var b=$(this).text().replace(":","__");a.cswCriteria.push(b);a.harvesterSelected.searches[0][b]||(a.harvesterSelected.searches[0][b]=
{value:""})})});a.cswCriteria.sort()}catch(h){a.cswCriteriaInfo=c("csw-FailedToParseCapabilities")}}).error(function(a){})}};a.$watch("harvesterSelected.site.capabilitiesUrl",function(){a.cswGetCapabilities()});a.harvesterTemplates=null;var l=function(){b.get("info@json?type=templates").success(function(b){a.harvesterTemplates=b.templates})};a.harvesterGetFeatureXSLT=null;var n=function(){a.oaipmhInfo=null;b.post("admin.harvester.info@json","<request><type>wfsFragmentStylesheets</type><schema>"+a.harvesterSelected.options.outputSchema+
"</schema></request>",{headers:{"Content-type":"application/xml"}}).success(function(b){a.harvesterGetFeatureXSLT=b[0]})};a.$watch("harvesterSelected.options.outputSchema",function(){a.harvesterSelected&&"wfsfeatures"===a.harvesterSelected["@type"]&&(n(),l())});a.threddsCollectionsMode="DIF";a.threddsAtomicsMode="DIF";a.harvesterThreddsXSLT=null;var m=function(){a.oaipmhInfo=null;var c=a.harvesterSelected.options;b.post("admin.harvester.info@json","<request><type>threddsFragmentStylesheets</type><schema>"+
("DIF"===a.threddsCollectionsMode?c.outputSchemaOnCollectionsDIF:c.outputSchemaOnCollectionsFragments)+"</schema></request>",{headers:{"Content-type":"application/xml"}}).success(function(b){a.harvesterThreddsXSLT=b[0]})};a.$watch("harvesterSelected.options.outputSchemaOnCollectionsDIF",function(){a.harvesterSelected&&"thredds"===a.harvesterSelected["@type"]&&(m(),l())});a.$watch("harvesterSelected.options.outputSchemaOnCollectionsFragments",function(){a.harvesterSelected&&"thredds"===a.harvesterSelected["@type"]&&
(m(),l())})}])})();(function(){angular.module("gn_system_settings_controller",[]).controller("GnSystemSettingsController",["$scope","$http","$rootScope","$translate","gnUtilityService",function(a,b,c,d,e){a.settings=[];var g=[],f=[];a.sectionsLevel1=[];a.sectionsLevel2=[];a.systemUsers=null;a.filterBySection=function(b){for(var c=[],d=0;d<a.settings.length;d++){var e=a.settings[d];-1!==e["@name"].indexOf(b)&&c.push(e)}return c};a.getOrderBy=function(a){return a["@position"]};a.saveSettings=function(f){b.get(a.url+"admin.config.save?"+
