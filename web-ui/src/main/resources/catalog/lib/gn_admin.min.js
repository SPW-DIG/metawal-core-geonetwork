...
"__");a.cswCriteria.push(b);a.harvesterSelected.searches[0][b]||(a.harvesterSelected.searches[0][b]={value:""})})});a.cswCriteria.sort()}catch(f){a.cswCriteriaInfo=c("csw-FailedToParseCapabilities")}}).error(function(a){})}};a.$watch("harvesterSelected.site.capabilitiesUrl",function(){a.cswGetCapabilities()});a.harvesterTemplates=null;var l=function(){b.get("info@json?type=templates").success(function(b){a.harvesterTemplates=b.templates})};a.harvesterGetFeatureXSLT=null;var n=function(){a.oaipmhInfo=
null;b.post("admin.harvester.info@json","<request><type>wfsFragmentStylesheets</type><schema>"+a.harvesterSelected.options.outputSchema+"</schema></request>",{headers:{"Content-type":"application/xml"}}).success(function(b){a.harvesterGetFeatureXSLT=b[0]})};a.$watch("harvesterSelected.options.outputSchema",function(){a.harvesterSelected&&"wfsfeatures"===a.harvesterSelected["@type"]&&(n(),l())});a.threddsCollectionsMode="DIF";a.threddsAtomicsMode="DIF";a.harvesterThreddsXSLT=null;var m=function(){a.oaipmhInfo=
