           ...
           'partials/drawbbox.html',
            ...
            link: function(scope, element, attrs) {
             ...
             attrs.hright !== '' && attrs.htop !== '') {
                scope.extent.md = [
                  parseFloat(parseFloat(attrs.hleft).toFixed(2)),
                  parseFloat(parseFloat(attrs.hbottom).toFixed(2)),
                  parseFloat(parseFloat(attrs.hright).toFixed(2)),
                  parseFloat(parseFloat(attrs.htop).toFixed(2))
                ];
              }
              ...
              scope.$watch('projs.form', function(newValue, oldValue) {
               ...
               scope.extent.form, oldValue, newValue
                ...
                scope.extent.form = [
                  parseFloat(parseFloat(scope.extent.form[0]).toFixed(2)),
                  parseFloat(parseFloat(scope.extent.form[1]).toFixed(2)),
                  parseFloat(parseFloat(scope.extent.form[2]).toFixed(2)),
                  parseFloat(parseFloat(scope.extent.form[3]).toFixed(2))
                ];
              ...
              dragbox.on('boxend', function(mapBrowserEvent) {
                ...
                scope.$apply(function() {
                  ...
                  while (x < len) {
                    scope.extent.form[x] =
                   parseFloat(scope.extent.form[x].toFixed(2));
                    x++;
                  }
                  setDcOutput();
                });
              ...
              scope.onRegionSelect = function(region) {
                ...
                scope.$apply(function() {
                  scope.extent.md = [
                    parseFloat(parseFloat(region.west).toFixed(2)),
